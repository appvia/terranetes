---
title: contexts.terraform.appvia.io
linkTitle: Context
sidebar_position: 1
---
# Context
...
<p class="crd-description">Context is the schema for the context type</p>
<dl class="crd-meta">
<dt class="fullname">Full name:</dt>
<dd class="fullname">contexts.terraform.appvia.io</dd>
<dt class="groupname">Group:</dt>
<dd class="groupname">terraform.appvia.io</dd>
<dt class="singularname">Singular name:</dt>
<dd class="singularname">context</dd>
<dt class="pluralname">Plural name:</dt>
<dd class="pluralname">contexts</dd>
...
<div class="property-description">
<p>ContextSpec defines the desired state for a context</p>
...
<div class="property-description">
<p>Variables is a list of variables which can be used globally by Context resources. The structure of the variables is a map of key/value pairs, which MUST have both a description and a value.</p>
...
<div class="property-description">
<p>ContextStatus defines the observed state of a terraform</p>
